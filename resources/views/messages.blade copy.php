                            ...
                            <ul class="list-unstyled contacts warning">
                                <li data-toggle="tab" data-target="#marked-message-1">
                                    ...
                                    <div class="vcentered info-combo">
                                        ...
                                        <h5> Hello, Dennis. I wanted to let you know we reviewed your proposal and decided
                                        </h5>
                                    </div>
                                    <div class="contacts-add">
                        ...
                        <div class="chat-body">
                            ...
                            <div class="message info">
                                ...
                                <div class="message-body">
                                    ...
                                    <hr>
                                    <div class="message-text">
                                        Hah, too late, I already bought it and my team is impleting the new design right
                                        now.
                                    </div>
                                </div>
                                <br>
                            ...
                            <div class="message my-message">
                                ...
                                <div class="message-body">
                                    <div class="message-body-inner">
                                        ...
                                        <hr>
                                        <div class="message-text">
                                            Hello. It's going well, thanks, but I may need your help tomorrow evening. Will
                                            you be available ?
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="chat-body">
                            <div class="message info">
                                ...
                                <div class="message-body">
                                    ...
                                    <hr>
                                    <div class="message-text">
                                        Hey, you asked for my feedback, it's brilliant. Damn, I envy you I didn't come up
                                        with something
                                        this good :D Keep it up, man, it's going to be very popular. Trust me !
                                    </div>
                                </div>
                                <br>
                            </div>
                        ...
                        <div class="chat-body">
                            <div class="message my-message">
                                ...
                                <div class="message-body">
                                    <div class="message-body-inner">
                                        ...
                                        <hr>
                                        <div class="message-text">
                                            Hi, I've just finished the stickers you wanted. I'll send them to you in an
                                            archive in 10 minutes.
                                        </div>
                                    </div>
                                </div>
                                <br>
                            ...
                            <div class="message success">
                                ...
                                <div class="message-body">
                                    ...
                                    <hr>
                                    <div class="message-text">
                                        Hello, Dennis. Thanks. Also how's it going with our latest football website. Do you
                                        need any
                            ...
                            <div class="message my-message">
                                ...
                                <div class="message-body">
                                    <div class="message-body-inner">
                                        ...
                                        <hr>
                                        <div class="message-text">
                                            It's going well, no need for any other help, thanks. Sure, send me a message
                        ...
                        <div class="chat-body">
                            ...
                            <div class="message success">
                                ...
                                <div class="message-body">
                                    ...
                                    <hr>
                                    <div class="message-text">
                                        Hello, Dennis. I will take a look at it tomorrow, because I'm already fed up with
                                        the current
                                        project.
                                    </div>
                                </div>
                        ...
                        <div class="chat-body">
                            <div class="message warning">
                                ...
                                <div class="message-body">
                                    ...
                                    <hr>
                                    <div class="message-text">
                                        Hello, Dennis. I wanted to let you know we reviewed your proposal and decided you'll
                                        start working
                                        together with our UI/UX team on Tuesday, January 10th, 2017. Congratulations and
                                        thank you!
                                    </div>
                                </div>
                                <br>
                        ...
                        <div class="chat-body">
                            <div class="message warning">
                                ...
                                <div class="message-body">
                                    ...
                                    <hr>
                                    <div class="message-text">
                                        Hey, we need your help for our next Telegram re-design. Are you available to talk
                                        about this
                                        tomorrow evening at around 8 PM ?
                                    </div>
                                </div>
                                <br>
                            </div>
                            ...
                            <div class="message my-message">
                                ...
                                <div class="message-body">
                                    <div class="message-body-inner">
                                        ...
                                        <hr>
                                        <div class="message-text">
                                            Hello, Mila, can you send me the latest pack of icons, I need all the source
                                            files. Thanks.
                                        </div>
                                    </div>
                                </div>
