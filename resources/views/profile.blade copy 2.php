...
<div class="container mx-auto ">
    ...
    <div class="relative">
        <img src="https://tecdn.b-cdn.net/img/new/slides/041.jpg" class="object-fill h-52 w-100 shadow-xl ring-1 ring-gray-400/10" alt="..." />
        <button class="absolute bottom-0 right-0  bg-white px-3 py-0 text-sm text-blue-500 shadow-sm rounded hover:bg-blue-800 m-2">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <div class="flex flex-col items-center">
                ...
                <div class="mt-6 flex flex-wrap gap-4 justify-center">
                    ...
                    <button type="button" class="btn bg-secondary btn-primary" data-toggle="modal" id="open_public_profile_edit">
                        Launch demo modal
                    </button>
    ...
    <div class="col-span-4 sm:col-span-9">
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <p class="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus
                ...
                egestas
                suscipit. Nunc finibus vel ante id euismod. Vestibulum ante ipsum primis in faucibus orci
                luctus
                et ultrices posuere cubilia Curae; Aliquam erat volutpat. Nulla vulputate pharetra tellus,
                in
            ...
            <div class="mb-6">
                ...
                <p class="mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus est
                    vitae
